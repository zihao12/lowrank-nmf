...
pval_pois.out.file <- sprintf("%s_%s_K%d_pval_poisson.png",dataname, method, K)
...
pval_pois.out.file  <- file.path(out.dir,pval_pois.out.file)
pval_pois_cts.out.file <- file.path(out.dir, pval_pois_cts.out.file)
...
pval_plot_poisson(counts, Lam, pval_pois.out.file,  main)
pval_plot_pois_cts(counts, Lam, pval_pois_cts.out.file,  main)
