...
outdir = '../bigdata';
factorsoutfile  = join([dataname, '_factors_fronmf.csv']);
loadingsoutfile = join([dataname, '_loadings_fronmf.csv']);
erroutfile = join([dataname, '_error_fronmf.csv']);
...
tic;
[A B err] = fronmf(counts,L0,F0',1e-06,1000);
timing = toc;
