...
% This code is copied from https://github.com/trigeorgis/Deep-Semi-NMF/edit/master/matlab/NNDSVD.m
% in flag = 1, negative values are set to 0.1, which may be improved as it
